    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-cyan elevation-4">
            ...
            <a href="home.html" class="brand-link" style="background-color: #044687;">
                <img src="<?= ASSETS; ?>img/newlogo.png" alt="AdminLTE Logo" class="bg-white brand-image img-circle elevation-3">
                <span class="brand-text font-weight-bold text-white ml-1">PTA-UP</span>
            </a>
            <?= $sidebar; ?>
        </aside>
